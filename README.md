...
| [`@xzzpig/pi-components`](./packages/pi-components)               | Shared Pi-native transcript primitives for extension authors: bounded event capture, native user/assistant/thinking rendering, tool results, and a scroll viewport.                                                           | Shared dependency                             |
