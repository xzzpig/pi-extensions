...
Generated 2026-09-07T21:44:58.447Z · agent-free (B8) · local machine numbers (p50/p95/max, ms unless noted).
...
|---|---|---|---|---|---|---|---|---|---|---|
| B1.settings.present | settings load (file present) | goal-settings | 1 settings file | 0 | 200 | 0 | 0 | 2.8 | 0ms | mean 0ms |
| B1.settings.present.lat25 | settings load (file present, +25ms/op) | goal-settings | 1 settings file | 0 | 100 | 0 | 0 | 0.5 | 25ms/op | mean 0ms |
| B1.settings.missing | settings load (file missing) | goal-settings | no file | 0 | 200 | 0 | 0 | 0.1 | 0ms | mean 0ms |
...
| B1.lock.uncontended | lock acquire+release (uncontended) | storage/goal-lock | fresh lock dir | 3 | 50 | 0.1 | 0.2 | 0.2 | 0ms | mean 0.1ms |
| B1.append.single | ledger append (single event) | goal-ledger | 1k-event ledger file | 1 | 50 | 0 | 0.2 | 1.4 | 0ms | mean 0.1ms |
| B1.append.x4 | ledger append x4 (batched, one write) | goal-ledger | 1k-event ledger file | 1 | 20 | 0 | 2.2 | 3.4 | 0ms | mean 0.4ms; one appendFileSync for 4 events (was 4×5 ops) |
| B3.parse.1000 | ledger full parse (1000 events) | goal-ledger | 1000 events | - | 10 | 0 | 0 | 0 | 0ms | mean 0ms |
| B3.reconstruct.1000 | ledger reconstruction (1000 events) | goal-ledger | 1000 in-memory events | - | 30 | 0.1 | 0.2 | 0.7 | 0ms | mean 0.1ms |
| B3.parse.5000 | ledger full parse (5000 events) | goal-ledger | 5000 events | - | 10 | 0 | 0 | 0 | 0ms | mean 0ms |
| B3.reconstruct.5000 | ledger reconstruction (5000 events) | goal-ledger | 5000 in-memory events | - | 30 | 0.4 | 0.9 | 1.9 | 0ms | mean 0.5ms |
| B3.parse.10000 | ledger full parse (10000 events) | goal-ledger | 10000 events | - | 10 | 0 | 0 | 0 | 0ms | mean 0ms |
| B3.reconstruct.10000 | ledger reconstruction (10000 events) | goal-ledger | 10000 in-memory events | - | 30 | 1.1 | 1.9 | 5 | 0ms | mean 1.3ms |
| B2.readturn.1g | per-turn read pipeline (1 goal, 1k ledger) | goal-settings + storage/goal-files + goal-ledger + prompts/goal-prompts | 1 goals, 1000 events | 0 | 20 | 0.1 | 7.7 | 7.7 | 0ms | fs ops/turn 0 (p50), mean 0.5ms |
| B2.readturn.10g | per-turn read pipeline (10 goals, 1k ledger) | goal-settings + storage/goal-files + goal-ledger + prompts/goal-prompts | 10 goals, 1000 events | 0 | 20 | 0 | 2.1 | 2.1 | 0ms | fs ops/turn 0 (p50), mean 0.1ms |
| B2.mutationturn.task | per-turn mutation (one update_goal_task) | goal-task-tools + goal-service + storage/goal-files + goal-ledger + storage/goal-lock | 1 goal, 1 task | 20 | 1 | 2.8 | 2.8 | 2.8 | 0ms | fs ops for one task mutation: 20 (P1-3 batches to one lock+write+append) |
...
| B5.startup.1g | session startup loadState (1 goal, parallel reads) | goal-state + storage/goal-files + goal-settings | 1 open goals | 0 | 6 | 0 | 1.1 | 1.1 | 0ms | mean 0.2ms; P1-7 parallel + cached |
...
| B5.startup.10g | session startup loadState (10 goals, parallel reads) | goal-state + storage/goal-files + goal-settings | 10 open goals | 0 | 6 | 0 | 1.7 | 1.7 | 0ms | mean 0.3ms; P1-7 parallel + cached |
...
| B5.startup.50g | session startup loadState (50 goals, parallel reads) | goal-state + storage/goal-files + goal-settings | 50 open goals | 0 | 6 | 0 | 5.2 | 5.2 | 0ms | mean 0.9ms; P1-7 parallel + cached |
...
| B5.lock.contended | lock acquire under two-process contention (child holds 3s, DEFAULT bounds) | storage/goal-lock | 2 processes, 1 goal lock | - | 1 | 37.7 | 37.7 | 37.7 | 0ms | fail-fast in 37.7ms; P1-5 bounded window ≈200ms (was ~2.8s frozen) |
| B5.auditor.dispatch | update_goal(complete) dispatch to pre-audit gate (auditor stubbed) | goal-core-tools + goal-completion + goal-state + goal-service + goal-ledger | 1 active goal each, 5 fixtures | - | 5 | 2.7 | 4 | 4 | 0ms | cold=1.5ms warm=4ms; P1-6 seeds the auditor session warm |
| B7.tool.create_goal | create_goal handler | goal-core-tools + goal-state + goal-service + goal-notifications | 1 focused fixture | 12 | 5 | 2.1 | 3.9 | 3.9 | 0ms | fs ops/case ~12; mean 2.3ms |
| B7.tool.get_goal | get_goal handler | goal-core-tools + goal-state + goal-format + goal-pool | 1 focused fixture | 0 | 5 | 0.2 | 1 | 1 | 0ms | fs ops/case ~0; mean 0.3ms |
| B7.tool.update_goal.paused | update_goal(paused) handler | goal-core-tools + goal-state + goal-service | 1 focused fixture | 17 | 5 | 2 | 4.8 | 4.8 | 0ms | fs ops/case ~17; mean 2.5ms |
| B7.tool.update_goal.blocked | update_goal(blocked) handler | goal-core-tools + goal-service + goal-ledger | 1 focused fixture | 17 | 5 | 1.8 | 2.4 | 2.4 | 0ms | fs ops/case ~17; mean 1.9ms |
| B7.tool.set_goal_tasks.50 | set_goal_tasks (50 tasks) handler | goal-task-tools + goal-task-confirmation + goal-policy + goal-service | 1 focused fixture | 17 | 5 | 1.6 | 5.6 | 5.6 | 0ms | fs ops/case ~17; mean 2.4ms |
| B7.tool.update_goal_task | update_goal_task(complete) handler | goal-task-tools + goal-service + storage/goal-lock + goal-ledger | 1 goal, 20 tasks | 20 | 5 | 1.5 | 2 | 2 | 0ms | fs ops/case ~20; mean 1.6ms |
| B7.evt.before_agent_start | before_agent_start event (1 goal, 1k ledger) | goal-events + goal-state + goal-service + goal-ledger + prompts/goal-prompts | 1 goal, 1000 events | - | 5 | 0 | 0.3 | 0.3 | 0ms | mean 0.1ms; P1-1/2 cut the reads here |
...
| B7.render.widgetLines | renderGoalWidgetLines (20 tasks) | widgets/goal-widget | 1 goal, 20 tasks | - | 100 | 0 | 0.1 | 1.4 | 0ms | mean 0.1ms |
| B7.render.widgetComponent | GoalWidgetComponent.render (mock TUI) | widgets/goal-widget | 1 goal, 20 tasks | - | 100 | 0 | 0.1 | 0.1 | 0ms | mean 0ms |
| B7.render.taskOverlay | task-list overlay render (20 tasks) | widgets/task-list-overlay | 1 goal, 20 tasks | - | 100 | 0 | 0.1 | 0.2 | 0ms | mean 0.1ms |
| B7.render.escapeDialog | escape dialog render | widgets/goal-escape-dialog | objective text | - | 100 | 0 | 0 | 0.1 | 0ms | mean 0ms |
...
| B7.pool.selectorLabel | goalSelectorLabel | goal-pool + goal-core | 1 goal | - | 2000 | 0 | 0 | 1 | 0ms | mean 0ms |
...
| B7.compaction.summary | buildCompactionSummary (500 events) | goal-compaction + goal-ledger | 1 goal, 500 events | - | 50 | 0 | 0.1 | 0.1 | 0ms | mean 0.1ms |
| B7.compaction.goalSummary | buildGoalCompactSummary (500 events) | goal-compaction | 1 goal, 500 events | - | 50 | 0 | 0 | 0.1 | 0ms | mean 0ms |
| B7.ledger.reconstruct | reconstructGoalLedger (500 events) | goal-ledger | 500 events | - | 50 | 0 | 0 | 0.1 | 0ms | mean 0ms |
...
| B7.dashboard.model.50t | deriveGoalDashboardModel (50 tasks, 12 events) | widgets/goal-dashboard-model + goal-activity + goal-core | 1 goal, 50 tasks, 12 events | - | 100 | 0 | 0 | 0.5 | 0ms | mean 0ms |
| B7.dashboard.compact.20t | renderCompactDashboard (20 tasks) | widgets/goal-dashboard-renderer | 1 goal, 20 tasks | - | 100 | 0 | 0.1 | 0.1 | 0ms | mean 0ms |
| B7.dashboard.expanded.20t | renderExpandedDashboard (20 tasks, 24 rows) | widgets/goal-dashboard-renderer | 1 goal, 20 tasks | - | 100 | 0.1 | 0.1 | 0.2 | 0ms | mean 0.1ms |
| B7.dashboard.expanded.50t | renderExpandedDashboard (50 tasks, 24 rows) | widgets/goal-dashboard-renderer | 1 goal, 50 tasks | - | 100 | 0.1 | 0.1 | 0.4 | 0ms | mean 0.1ms |
...
| B7.dashboard.auditor | deriveAuditorDashboardModel + renderAuditorDashboard (running) | widgets/auditor-dashboard-model + widgets/goal-dashboard-renderer | running audit | - | 100 | 0 | 0 | 0.1 | 0ms | mean 0ms |
...
| B7.dashboard.anchoredScroll.50t | flatten + anchoredScrollOffset (50 tasks) | widgets/goal-dashboard-model | 50-task tree | - | 500 | 0 | 0 | 0.1 | 0ms | mean 0ms |
...
| B7.dashboard.statusText | buildGoalStatusText standard (20 tasks) | goal-status + widgets/goal-dashboard-* | 1 goal, 20 tasks, 12 events | - | 100 | 0.1 | 0.1 | 0.6 | 0ms | mean 0.1ms |
